...
# FIXME: change -01 by -03 and remove -ggdb // by topo
CFLAGS+=-g -Wall \
	-O3 \
	-ggdb \
	-fomit-frame-pointer \
...
#   PCAP_LIB=-lpcap
   ...
   LIBS=-L/usr/lib -L. -lz -lelf -ldl /usr/lib/x86_64-linux-gnu/libelf.a $(PTHREAD_LIBS)
   DESTDIR=/usr
else
...
ifeq ($(shell uname -o), Cygwin)
   ...
   LIBS=-L. -lz -lelf -ldl /usr/lib/x86_64-linux-gnu/libelf.a -lpthread
endif
endif
endif
endif
...
HDR=mempool.h registry.h rbtree.h hash.h utils.h parser.h plugin.h \
	...
	rommon_var.h \
    gdb_server.h gdb_proto.h gdb_cmd.h gdb_utils.h
...
SOURCES=mempool.c registry.c rbtree.c hash.c sbox.c utils.c parser.c \
	...
	gdb_proto.c gdb_server.c gdb_cmd.c \
	hv_vm_gdb_debug.c \
	hv_store.c \
